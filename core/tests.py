...
company = Company()
company.name = 'mmPOS SpA'
company.ruc = ''.join(random.choices(numbers, k=13))
company.email = 'alejandro@aemm.cl'
company.phone = ''.join(random.choices(numbers, k=7))
company.mobile = ''.join(random.choices(numbers, k=10))
company.description = 'Informática.'
company.website = 'https://www.aemm.cl'
company.address = 'Huechuraba'
company.iva = 12.00
company.save()
