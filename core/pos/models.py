...
class Company(models.Model):
    ...
    ruc = models.CharField(max_length=13, verbose_name='Rut')
    ...
    redondeoiva = models.IntegerField(default=0, verbose_name='Decimales Redondeo Iva')
...
class Sale(models.Model):
    ...
    def calculate_invoice(self):
        ...
        for i in self.saledetail_set.filter():
            ...
            i.subtotal = round(i.subtotal, redondeo)                    # AEMM  
            i.total_dscto = float(i.dscto) * float(i.subtotal)
            i.total_dscto = round(i.total_dscto, redondeo)              # AEMM
