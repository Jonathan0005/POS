        ...
        try:
            if action == 'add':
                with transaction.atomic():
                    redondeo = Company.objects.first().redondeoiva
                    sale = Sale()
                    ...
                    for i in json.loads(request.POST['products']):
                        ...
                        saledetail.subtotal = float(i['subtotal'])
                        ...
                        saledetail.total_dscto = float(i['total_dscto'])
                        #saledetail.total = saledetail.subtotal - saledetail.total_dscto
                        saledetail.total = float(i['total'])
                        saledetail.save()
